...
const Dashboard = () => {
  return (
    ...
    <div className='flex bg-gray-50'> 
      <div class="relative ml-[220px] w-[30%] flex min-h-screen flex-col justify-center overflow-hidden bg-gray-50 py-6 sm:py-12">
        <div
          ...
          <div class="relative z-10 mx-auto max-w-md">
            <div className='flex text-center'>
              ...
              <p className=' ml-2 text-2xl font-semibold space-y-6 pt-5 leading-7 text-gray-600 transition-all duration-300 group-hover:text-white/90'>
                Total Payment
              </p>
            </div>
            <div
      ...
      <div class="relative flex w-[24%] min-h-screen flex-col justify-center overflow-hidden bg-gray-50 py-6 sm:py-12">
        <div
          class="group relative cursor-pointer overflow-hidden bg-white px-6 pt-10 pb-8 shadow-xl ring-1 ring-gray-900/5 transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl sm:mx-auto sm:max-w-sm sm:rounded-lg sm:px-10">
